# Generated by Django 3.2.18 on 2023-06-01 16:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('need_confirm', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reported_post', to='app_planets.post')),
